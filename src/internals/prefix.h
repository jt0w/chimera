...
#define sb_len             chimera_sb_len
#define sb_push            chimera_sb_push
#define sb_push_sized_buf  chimera_sb_push_sized_buf
...
#define flags_check        chimera_flags_check
#define flags_err_str      chimera_flags_err_str
